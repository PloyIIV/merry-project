    ...
    <div className="flex justify-around h-20 items-center shadow-md relative z-10">
      {clicked ? (
        <div
          ...
          className="z-50 flex flex-col w-[230px] h-[250px] p-3 bg-white text-pgray-700 rounded-xl shadow-2xl border border-pgray-400 shadow-gray-600 absolute right-[14%] top-16"
        >
          ...
          <div className="text-sm">
            <div
              ...
              className="flex py-2 hover:bg-pgray-200 hover:rounded-xl cursor-pointer"
            >
          ...
          <div
            onClick={() => logout()}
            className="flex py-2 mt-1 items-center cursor-pointer hover:bg-pgray-200 hover:rounded-xl"
          >
      ...
      {notiClicked ? (
        <div
          onMouseLeave={() => setNotiClicked(!notiClicked)}
          className="z-50 flex flex-col w-[15%] p-2 bg-white text-pgray-700 rounded-xl shadow-2xl border border-pgray-400 shadow-gray-600 absolute right-[14%] top-16"
        >
          <div className="rounded-md p-2 flex hover:bg-pgray-200 mb-1">
            <div className="relative">
              ...
              <img
                ...
                src="https://parade.com/.image/t_share/MTk0OTMzNjkzNDM1ODgwOTg0/gettyimages-1445629372.jpg"
                alt="sadies"
              />
            </div>
            <div className="ml-3">
              <p className="text-sm">
                '<span className="font-semibold">Sadies Sink</span>' Just Merry
                you!
              </p>
              <p className="text-[13px]">Click here to see profile</p>
            </div>
          </div>
          <div className="rounded-md p-2 flex hover:bg-pgray-200">
            <div className="relative">
              <svg
                className="absolute bottom-1 right-0"
                width="15"
              ...
              <img
                className="w-10 h-10 object-cover rounded-full"
                src="https://cdni-hw.ch7.com/dm/sz-md/i/images/2024/01/04/659663ab96a002.36484583.jpg"
                alt="sadies"
              />
            </div>
            <div className="ml-2">
              <p className="text-sm">
                '<span className="font-semibold">Aum</span>' Merry you back!
              </p>
              <p className="text-[13px]">Let's start conversation now</p>
            </div>
          </div>
        </div>
      ) : (
      ...
      <div className="flex items-center">
        <div>
          <button
            ...
            className="font-bold text-putility-600"
          >
            Start Matching!
          </button>
        ...
        <div>
          <button onClick={() => setNotiClicked(!notiClicked)}>
            {notiButton}
          </button>
