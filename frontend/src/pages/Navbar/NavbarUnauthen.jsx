...
const NavbarUnauthen = () => {
  ...
  return (
    <div className='flex justify-around h-20 items-center shadow-xl relative z-10'>
        <Logo />
        <div>
            <button className='font-bold text-ppurple-800'><a href={`${url}/#why-merry`}>Why Merry Match?</a></button>
            <button className='font-bold text-ppurple-800 px-8'><a href={`${url}/#how-to`}>How to Merry</a></button>
