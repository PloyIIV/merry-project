...
const Matching = () => {
  ...
  return (
    <div className="flex calHeight">
            ...
            >
              {!loading && users.image ? (
                users.image.map((img, index) => {
                  return (
                    <SwiperSlide key={index} className="w-[250px] md:w-[350px] lg:w-[400px] lg:h-[400px] xl:w-[500px] xl:h-[500px] 2xl:w-[700px] 2xl:h-[700px]">
                ...
                <div className="w-full h-[500px] items-center flex justify-center relative z-50">
      ...
      <div className="hidden xl:flex xl:w-[14%]">
        <FilterSideBar />
      </div>
    </div>
  );
